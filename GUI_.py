...
def update_textbox():
    global predicted_text,number_of_blank_frames
    gui.text_view.delete(1.0, tk.END)

    # Überprüfen, ob number_of_blank_frames größer als 33 sind

    if len(number_of_blank_frames)>=33:
...
class GUI:
    ...
    def update_video_stream(self):
        while self.is_streaming:
            ...
            global hand_landmarks,left_hand,right_hand,number_of_blank_frames
